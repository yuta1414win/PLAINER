...
import type { Project, Step, UUID, URLString } from '@/lib/types';

// サンプルデータ
const createSampleProject = (): Project => ({
  id: 'sample-project' as UUID,
  ...
  steps: [
    ...
    },
    {
      ...
      thumbnail: 'data:image/svg+xml;base64,' as URLString,
      hotspots: [
        {
          id: 'hotspot-2' as UUID,
          shape: 'rect',
          x: 0.19,
          y: 0.25,
          w: 0.62,
